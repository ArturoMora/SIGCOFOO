(function () {
    ...
    function InformeAnualGetCtrl(AuthService, $scope, $state, $stateParams, RolesUsuarioCPService, InformesAnualesCPService) {
        ...
        $scope.cargaRegistros=function(){
            InformesAnualesCPService.GetAllByComunidad($scope.comunidadId).then(
                function (result) {
        ...
        $scope.detalleOC = function (idRegistro) {
            $state.go("InformeAnualDetails", { id: idRegistro });
        }

        $scope.eliminaRegistro = function (idRegistro) {
            InformesAnualesCPService.DeleteOCWithAutores(idRegistro).then(function (result) {
