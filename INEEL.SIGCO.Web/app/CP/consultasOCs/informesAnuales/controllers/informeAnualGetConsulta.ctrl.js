(function () {
    ...
    angular
        ...
        .controller("InformeAnualGetConsultaCtrl", [
            ...
            InformeAnualGetConsultaCtrl
        ]);

    function InformeAnualGetConsultaCtrl(AuthService, $scope,$state, InformesAnualesCPService) {
        ...
        $scope.buscar = function () {
            ...
            InformesAnualesCPService.getAllConsultaPorOC($scope.busq).then(
                function (result) {
