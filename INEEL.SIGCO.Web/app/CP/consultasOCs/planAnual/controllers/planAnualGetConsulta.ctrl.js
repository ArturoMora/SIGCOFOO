(function () {
    ...
    angular
        ...
        .controller("PlanAnualGetConsultaCtrl", [
            ...
            PlanAnualGetConsultaCtrl
        ]);

    function PlanAnualGetConsultaCtrl(AuthService, $scope,$state, PlanesAnualesCPService) {
        ...
        $scope.buscar = function () {
            ...
            PlanesAnualesCPService.getAllConsultaPorOC($scope.busq).then(
                function (result) {
