(function () {
    ...
    app.controller("comite", ["AuthService", "$scope", "ComiteService", "$uibModal", "DTOptionsBuilder", "DTColumnBuilder", "DTColumnDefBuilder", comite]);
    function comite(AuthService, $scope, ComiteService, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
        ...
        ComiteService.getAll().then(
            ...
            function (err) {
                toastr.error("No se han podido cargar los registros de Comite");
            });
    }
})();