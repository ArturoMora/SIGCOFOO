(function () {
    ...
    app.controller("factorInnovacion", ["AuthService", "$scope", "FactorInnovacionService", "$uibModal", "DTOptionsBuilder", "DTColumnBuilder", "DTColumnDefBuilder", factorInnovacion]);
    function factorInnovacion(AuthService, $scope, FactorInnovacionService, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
        ...
        //obtener registros
        FactorInnovacionService.getAll().then(
            function (result) {
            ...
            function (err) {
                toastr.error("No se han podido cargar los registros de Factor Innovación");
            });
    }
})();