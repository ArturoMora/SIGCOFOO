(function () {
    ...
    app.controller("tipoAcceso", ["AuthService", "$scope", "TipoAccesoService", "$uibModal", "DTOptionsBuilder", "DTColumnBuilder", "DTColumnDefBuilder", tipoAcceso]);
    function tipoAcceso(AuthService, $scope, TipoAccesoService, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
        ...
        TipoAccesoService.getAll().then(
            ...
            function (err) {
                toastr.error("No se han podido cargar los registros de Tipo de Acceso");
            });
    }
})();