(function () {
    ...
    angular
        ...
        .controller("competenciatecnicaAddCtrl"
            ...
            , '$state'
            , '$filter'
            , competenciatecnicaAddCtrl]);
    function competenciatecnicaAddCtrl(AuthService, $scope, MECService, globalGet, uploadFileACH, $state, $filter) {
        //Variable API
        ...
        $scope.add = function () {
            if ($scope.ValidForm.$invalid) {
                ...
                MECService.createTecnica($scope.registro).then(
                    function (result) {
