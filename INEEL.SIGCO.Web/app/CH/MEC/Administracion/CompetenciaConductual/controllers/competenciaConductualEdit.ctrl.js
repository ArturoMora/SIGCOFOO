(function () {
    ...
    angular
        ...
        .controller("competenciaconductualEditCtrl", ['AuthService', '$scope', '$rootScope', 'MECService', 'globalGet', '$state', '$filter', "$stateParams", "FileUploader", "uploadFileACH", competenciaconductualEditCtrl]);

    function competenciaconductualEditCtrl(AuthService, $scope, $rootScope, MECService, globalGet, $state, $filter, $stateParams, FileUploader, uploadFileACH) {
        ...
        MECService.getbyidConductual(id).then(
            function (result) {
        ...
        $scope.update = function () {
            if ($scope.ValidForm.$invalid) {
                ...
                MECService.updateConductual($scope.registro).then(
                    function (result) {
        ...
        $scope.deleteFile = function () {
            ...
            MECService.updateConductual($scope.registro);
