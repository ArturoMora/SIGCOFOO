...
(function () {
    ...
    angular
        .module("ineelCH")
        .controller("detalleevaluacionestecnicasCtrlGet", ['$rootScope','$scope', 'detalletecnicaService', 'globalGet', '$state', '$stateParams', detalleevaluacionestecnicasCtrlGet]);

    function detalleevaluacionestecnicasCtrlGet($rootScope, $scope,  detalletecnicaService, globalGet, $state, $stateParams) {
