...
(function () {
    ...
    angular
        .module("ineelCH")
        .controller("consultaevaluacionestecalcanzadasCtrlGet", ["AuthService", "MenuService", '$rootScope', '$scope', 'periodoevaluacionService', 'evaluaciontecnicaService', 'globalGet', '$state', '$stateParams', consultaevaluacionestecalcanzadasCtrlGet]);

    function consultaevaluacionestecalcanzadasCtrlGet(AuthService, MenuService, $rootScope, $scope, periodoevaluacionService, evaluaciontecnicaService, globalGet, $state, $stateParams) {
