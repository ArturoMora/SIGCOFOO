...
(function () {
    ...
    angular
        .module("ineelCH")
        .controller("consultaevaluacionesconductualesCtrlGet", ["AuthService", "MenuService", '$rootScope', '$scope', 'periodoevaluacionService', 'evaluacionconductualService', 'globalGet', '$state', '$stateParams', consultaevaluacionesconductualesCtrlGet]);

    function consultaevaluacionesconductualesCtrlGet(AuthService, MenuService,$rootScope, $scope, periodoevaluacionService, evaluacionconductualService, globalGet, $state, $stateParams) {
        ...
        $scope.parametrosTransferencia = function (clave, nombre, categoriaEmp, categoriaCom, calificacion, claveevaluacion, idcategoriacompetencia, nombreFamilia, idReg) {
            ...
            $state.go("detalleevaluacionconductual", { id: idReg });
        }
