...
(function () {
    ...
    angular
        .module("ineelCH")
        .controller("detalleevaluacionesconductualesAdmCtrlGet", ['$rootScope', '$scope', 'detalleevaluacionconductualService', 'evaluacionconductualService', 'globalGet', '$state', '$stateParams', detalleevaluacionesconductualesAdmCtrlGet]);

    function detalleevaluacionesconductualesAdmCtrlGet($rootScope, $scope, detalleevaluacionconductualService, evaluacionconductualService, globalGet, $state, $stateParams) {
