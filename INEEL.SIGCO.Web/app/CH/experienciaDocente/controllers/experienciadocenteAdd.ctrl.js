(function () {
    ...
    angular
        ...
        , ['$rootScope', 'AuthService'
            , '$scope'
            , 'ExperienciaDocenteService'
            , 'globalGet'
            , 'uploadFileACH'
            , '$state'
            , '$filter'
            , '$uibModal'
            , experienciadocenteCtrlAdd]);
    function experienciadocenteCtrlAdd($rootScope, AuthService, $scope, ExperienciaDocenteService, globalGet, uploadFileACH, $state, $filter, $uibModal) {
        //Variable API
        ...
        $scope.add = function () {
            if ($scope.ValidForm.$invalid) {
                ...
                ExperienciaDocenteService.add($scope.registro).then(
                    function (result) {
