(function () {
    ...
    angular
        .module("ineelCH")
        .controller("becariointernoDetailsCtrl", ['AuthService', '$scope', 'BecarioInternoService', "$stateParams","globalGet", becariointernoDetailsCtrl]);

    function becariointernoDetailsCtrl(AuthService, $scope, BecarioInternoService, $stateParams, globalGet) {
