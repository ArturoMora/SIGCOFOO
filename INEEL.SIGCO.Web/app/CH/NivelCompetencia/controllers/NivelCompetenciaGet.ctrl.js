...
(function () {
    angular
        .module("ineelCH")
        .controller("nivelcompetenciaCtrlGet", ['$scope', 'nivelcompetenciaService', "$uibModal", "DTOptionsBuilder", "DTColumnBuilder", "DTColumnDefBuilder", nivelcompetenciaCtrlGet]);

    function nivelcompetenciaCtrlGet($scope, nivelcompetenciaService, $uibModal, DTOptionsBuilder, DTColumnBuilder, DTColumnDefBuilder) {
            ...
            var modalInstance = $uibModal.open({
                ...
                controller: function ($uibModalInstance) {
                    $scope.ok = function () {
                        ...
                        nivelcompetenciaService.updateEstado(registro);
