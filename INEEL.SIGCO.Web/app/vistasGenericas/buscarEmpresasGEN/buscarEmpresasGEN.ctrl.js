(function () {
    ...
    angular
        ...
        .controller("BuscaEmpresasGENCtrl", [
            "$scope",
            "$stateParams",
            "$uibModalInstance",
            "DTOptionsBuilder",
            ...
            "$uibModal",
            "globalGet",
            BuscaEmpresasGENCtrl
        ])

    function BuscaEmpresasGENCtrl($scope, $stateParams, $uibModalInstance, DTOptionsBuilder, DTColumnBuilder,
                    $compile,$uibModal,globalGet) {
        $scope.dataFull = [];
        $scope.loading = true;
        var tabla = this;
        tabla.dtInstance = {};
