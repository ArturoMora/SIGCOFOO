(function () {
    ...
    angular
        ...
        .module("ineelCP")
        .controller("EmpresasCPGetGralCtrl", [
            "$scope",
            "$http",
            "$state",
            "$stateParams",
            ...
            "$uibModal",
            "globalGet",
            EmpresasCPGetGralCtrl
        ])

    function EmpresasCPGetGralCtrl($scope, $http,
                    $state,
                    $stateParams,
                    $uibModalInstance,
                    DTOptionsBuilder,
        ...
        $scope.crearEmpresa = function () {
            ...
            var modalInstance = $uibModal.open({
                size: 'lg',
                templateUrl: 'app/vistasGenericas/empresaCPModalAdd.html',
                controller: 'EmpresaCPModalAddCtrl as showCase',
                scope: $scope,
            });
