...
(function () {
    ...
    angular.module("directivasSIGCO")
        .controller('uoModalPersonaCtrl', ['$scope', '$uibModal', uoModalPersonaCtrl])
        .controller("PersonasModalFilterGetCtrlActivo",
        ["$scope", "$state", "$stateParams",
            "$uibModal", "$uibModalInstance",
            "$http", "globalGet",
            PersonasModalFilterGetCtrlActivo])
        .directive('personasSelectActivo', function () {
            return {
                restrict: 'ACE',
                templateUrl: function (elem, attrs) {
                    return attrs.templateUrl || 'app/vistasGenericas/directivas/buscarPersonasDirective/buscarPersonas.html';
                },
                controller: "uoModalPersonaCtrl",
                require: 'ngModel',
                scope: {
                    arreglo: "=?enarreglo",
                    ngModel: '=',
    ...
    function PersonasModalFilterGetCtrlActivo($scope, $state, $stateParams, $uibModal, $uibModalInstance,
        $http, globalGet) {
    ...
    ;
    function uoModalPersonaCtrl($scope, $uibModal) {
