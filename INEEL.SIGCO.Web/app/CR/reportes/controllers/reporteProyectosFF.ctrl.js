(function () {
    ...
    angular
        ...
        .controller("reporteProyectosCtrl", [
            ...
            'ReportesFFCRService',
            '$uibModal',
            reporteProyectosCtrl]);
    function reporteProyectosCtrl($scope, DTOptionsBuilder, ReportesFFCRService, $uibModal) {
        ...
        $scope.titulo = "Catálogo de proyectos por Fuente de Financiamiento"
        ...
        $scope.obtenerInformacion = function () {
            ...
            //}
            //obtener registros
            $scope.proyectosFF.fuenteFinanciamientoId = $scope.fuenteFinanciamientoId;
            $scope.proyectosFF.tipoFuenteFinanciamientoId = $scope.tipoFuenteFinanciamientoId;
            $scope.proyectosFF.fondoProgramaId = $scope.fondoProgramaId;
            $scope.proyectosFF.convocatoriaId = $scope.convocatoriaId;
            debugger;
            if ($scope.uoselecionada != undefined) {
                $scope.proyectosFF.claveunidad = $scope.uoselecionada.claveUnidad;
            } else {
                $scope.proyectosFF.claveunidad = "";
            }
           
            
            ReportesFFCRService.getProyectosByFF($scope.proyectosFF).then(
                function (result) {
                ...
                function (err) {
                    toastr.error("No se ha podido cargar el contenido");
                }
            );
