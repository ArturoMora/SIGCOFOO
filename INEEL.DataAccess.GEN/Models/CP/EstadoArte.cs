...
{
    [Table("CP.tab_EstadoArte")]
    public class EstadoArte
    {
        public EstadoArte() { }

        [Key]
        public int EstadoArteId { get; set; }
        public string Nombre { get; set; }
        public string Descripcion { get; set; }
        public DateTime FechaRegistro { get; set; }
        public string PersonaAutoriza { get; set; }  //platicar con JLT la procedencia de estos valores
