namespace INEEL.DataAccess.GEN.MigrationsMT
{
    ...
    public partial class faltaMT0609 : DbMigration
    {
        public override void Up()
        {
            ...
            //    .ForeignKey("CH.cat_Disciplinas", t => t.DisciplinaId, cascadeDelete: true)
            ...
            //    .ForeignKey("CH.cat_Campos", t => t.CampoId, cascadeDelete: true)
            //    .Index(t => t.CampoId);
            ...
            //CreateTable(
            //    "CH.cat_GradoAcademico",
            //    c => new
            //        {
            //            GradoAcademicoId = c.Int(nullable: false, identity: true),
            //            FechaEfectiva = c.DateTime(nullable: false),
            //            Descripcion = c.String(maxLength: 200),
            //            DescripcionCorta = c.String(maxLength: 50),
            //            Estado = c.Int(),
            //        })
            //    .PrimaryKey(t => t.GradoAcademicoId);
            
            //CreateTable(
            //    "CH.cat_Instituciones",
            //    c => new
            //        {
        ...
        public override void Down()
        {
            ...
            //DropForeignKey("CH.cat_Instituciones", "PaisID", "CH.cat_Pais");
            ...
            //DropForeignKey("CH.cat_Carreras", "DisciplinaId", "CH.cat_Disciplinas");
            //DropForeignKey("CH.cat_Disciplinas", "CampoId", "CH.cat_Campos");
            ...
            //DropIndex("CH.cat_Instituciones", new[] { "PaisID" });
            //DropIndex("CH.cat_Disciplinas", new[] { "CampoId" });
            //DropIndex("CH.cat_Carreras", new[] { "DisciplinaId" });
            ...
            //DropTable("CH.cat_Instituciones");
            //DropTable("CH.cat_GradoAcademico");
            //DropTable("CH.cat_Campos");
            //DropTable("CH.cat_Disciplinas");
            //DropTable("CH.cat_Carreras");
