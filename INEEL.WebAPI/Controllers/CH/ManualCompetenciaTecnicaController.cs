...
{
    public class ManualCompetenciaTecnicaController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(ManualCompetenciaTecnicaController));
        ManualCompetenciaTecnicaRepository _repository;
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create(ManualCompetenciaTecnica Obj)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
