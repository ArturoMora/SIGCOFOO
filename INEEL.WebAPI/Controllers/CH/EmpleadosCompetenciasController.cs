...
{
    public class EmpleadosCompetenciasController : ApiController
    {
        EmpleadosCompetenciasRepository _repository;

        public EmpleadosCompetenciasController()
        {
            _repository = new EmpleadosCompetenciasRepository();
        }
        ...
        [AllowAnonymous]
        [HttpPost]
        public async Task<IHttpActionResult> Create(EmpleadosCompetencias datos)
        {
            try
            {
        ...
        [AllowAnonymous]
        [HttpPut]
        public async Task<IHttpActionResult> Update(EmpleadosCompetencias datos)
        {
            try
            {
