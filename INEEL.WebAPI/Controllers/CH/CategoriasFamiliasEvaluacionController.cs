...
{
    public class CategoriasFamiliasEvaluacionController : ApiController
    {
        CategoriasFamiliasEvaluacioRepository _repository;

        public CategoriasFamiliasEvaluacionController()
        {
            _repository = new CategoriasFamiliasEvaluacioRepository();
        }
        ...
        [AllowAnonymous]
        [HttpPost]
        public async Task<IHttpActionResult> Create(CategoriasFamiliasEvaluacion datos)
        {
            try
            {
        ...
        [AllowAnonymous]
        [HttpPut]
        public async Task<IHttpActionResult> Update(CategoriasFamiliasEvaluacion datos)
        {
            try
            {
