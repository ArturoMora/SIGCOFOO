...
{
    public class CategoriasCompetenciasSindController : ApiController
    {
         
        private static readonly ILog log = LogManager.GetLogger(typeof(CategoriasCompetenciasSindController));

        CategoriasCompetenciasSindRepository _repository;

        public CategoriasCompetenciasSindController()
        {
            _repository = new CategoriasCompetenciasSindRepository();
        }
        ...
        [HttpPost][Authorize] public async Task<IHttpActionResult> Create(CategoriasCompetenciasSind datos)
        {
            try
            {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(CategoriasCompetenciasSind datos)
        {
            try
            {
                log.Info(new MDCSet(this.ControllerContext.RouteData));
