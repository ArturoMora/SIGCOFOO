...
{
    [Authorize]
    public class TipoAreaController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(TipoAreaController));
        TipoAreaRepository _repository;

        public TipoAreaController() {
            _repository = new TipoAreaRepository();
        }
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(TipoArea obj)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
                await _repository.Update(obj);
                return Ok("Tipo de área actualizada correctamente!");
            }
            catch (Exception e) { log.Error(new MDCSet(this.ControllerContext.RouteData), e);
                return InternalServerError(e);
            }
        ...
        public async Task<IHttpActionResult> Delete(int Id){try{log.Info(new MDCSet(this.ControllerContext.RouteData), new InfoException(Id));
                ...
                return Ok("Tipo de área eliminada correctamente!");
