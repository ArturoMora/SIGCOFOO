...
{
    [Authorize]
    public class CalificacionCompetenciasController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(CalificacionCompetenciasController));

        CalificacionCompetenciasRepository _repository;
        public CalificacionCompetenciasController()
        {
            _repository = new CalificacionCompetenciasRepository();
        }
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(CalificacionCompetencias obj)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
