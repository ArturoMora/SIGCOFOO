...
{
    public class CalificacionSindController : ApiController
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(CalificacionSindController));

        CalificacionSindRepository _repository;

        public CalificacionSindController()
        {
            _repository = new CalificacionSindRepository();
        }
        ...
        [HttpPost][Authorize] public async Task<IHttpActionResult> Create(CalificacionSind datos)
        {
            try
            {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(CalificacionSind datos)
        {
            try
            {
                log.Info(new MDCSet(this.ControllerContext.RouteData));
