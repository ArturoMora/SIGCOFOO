...
{
    public class AvanceMiembrosController : ApiController
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(AvanceMiembrosController));
        private AvanceMiembrosRepository _entityRepo;

        public AvanceMiembrosController()
        {
            _entityRepo = new AvanceMiembrosRepository();
        ...
        [Authorize]
        [HttpPost]
        public async Task<IHttpActionResult> Create([FromBody]AvanceMiembros model)
        {
