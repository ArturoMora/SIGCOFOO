...
{
    public class AmbitoConvController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AmbitoConvController));  
        private AmbitoConvRepository _entityRepo;
        
        public AmbitoConvController()
        {
            _entityRepo = new AmbitoConvRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]AmbitoConv model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]AmbitoConv model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]AmbitoConv model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
