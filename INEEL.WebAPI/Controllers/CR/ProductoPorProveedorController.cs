...
{
    public class ProductoPorProveedorController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(ProductoPorProveedorController));  
        // AYUDA:
        ...
        private ProductoPorProveedorRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public ProductoPorProveedorController()
        {
            _entityRepo = new ProductoPorProveedorRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]ProductoPorProveedor model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]ProductoPorProveedor model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]ProductoPorProveedor model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
