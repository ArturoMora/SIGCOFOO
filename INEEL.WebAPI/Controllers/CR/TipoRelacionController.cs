...
{
    public class TipoRelacionController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(TipoRelacionController));
        private TipoRelacionRepository _entityRepo;
        public TipoRelacionController()
        {
            _entityRepo = new TipoRelacionRepository();
        }
