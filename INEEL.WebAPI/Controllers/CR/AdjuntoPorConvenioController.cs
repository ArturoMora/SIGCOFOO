...
{
    public class AdjuntoPorConvenioController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AdjuntoPorConvenioController));  
        // AYUDA:
        ...
        private AdjuntoPorConvenioRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public AdjuntoPorConvenioController()
        {
            _entityRepo = new AdjuntoPorConvenioRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]AdjuntoPorConvenio model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]AdjuntoPorConvenio model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]AdjuntoPorConvenio model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
