...
{
    public class SegmentoMercadoController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(SegmentoMercadoController));   
        private SegmentoMercadoRepository _entityRepo;
        public SegmentoMercadoController()
        {
            _entityRepo = new SegmentoMercadoRepository();
        }
