...
{
    public class IntegranteGrupoColegiadoExternoController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(IntegranteGrupoColegiadoExternoController));  
        // AYUDA:
        ...
        private IntegranteGrupoColegiadoExternoRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public IntegranteGrupoColegiadoExternoController()
        {
            _entityRepo = new IntegranteGrupoColegiadoExternoRepository();
