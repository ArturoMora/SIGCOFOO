...
{
    public class ProveedorController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(ProveedorController));  
        // AYUDA:
        ...
        private ProveedorRepository _entityRepo;
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]Proveedor model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]Proveedor model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
