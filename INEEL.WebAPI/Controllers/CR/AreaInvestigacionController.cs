...
{
    public class AreaInvestigacionController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AreaInvestigacionController));  
        // AYUDA:
        ...
        private AreaInvestigacionRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public AreaInvestigacionController()
        {
            _entityRepo = new AreaInvestigacionRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]AreaInvestigacion model)
        {
