...
{
    public class TematicaController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(TematicaController));
        private TematicaRepository _entityRepo;
        public TematicaController()
        {
            _entityRepo = new TematicaRepository();
        }
