...
{
    public class PersonalActividadAdicionalController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AreaActividadAdicionalController));  
        // AYUDA:
        ...
        private PersonaActividadAdicionalRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public PersonalActividadAdicionalController()
        {
            _entityRepo = new PersonaActividadAdicionalRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create(PersonalActividadAdicional model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(PersonalActividadAdicional model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado(PersonalActividadAdicional model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
