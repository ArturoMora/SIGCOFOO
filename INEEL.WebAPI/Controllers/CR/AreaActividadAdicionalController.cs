...
{
    public class AreaActividadAdicionalController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AreaActividadAdicionalController));  
        // AYUDA:
        ...
        private AreaActividadAdicionalRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public AreaActividadAdicionalController()
        {
            _entityRepo = new AreaActividadAdicionalRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]AreaActividadAdicional model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]AreaActividadAdicional model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]AreaActividadAdicional model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
