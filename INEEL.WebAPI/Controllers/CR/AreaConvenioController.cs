...
{
    public class AreaConvenioController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AreaConvenioController));  
        // AYUDA:
        ...
        private AreaConvenioRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public AreaConvenioController()
        {
            _entityRepo = new AreaConvenioRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]AreaConvenio model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(AreaConvenio model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]AreaConvenio model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
