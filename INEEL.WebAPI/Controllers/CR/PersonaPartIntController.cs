...
{
    public class PersonaPartIntController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(PersonaPartIntController));  
        // AYUDA:
        ...
        private PersonaPartIntRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public PersonaPartIntController()
        {
            _entityRepo = new PersonaPartIntRepository();
