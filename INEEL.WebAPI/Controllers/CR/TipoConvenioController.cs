...
{
    public class TipoConvenioController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(TipoConvenioController));
        private TipoConvenioRepository _entityRepo;
        public TipoConvenioController()
        {
            _entityRepo = new TipoConvenioRepository();
        }
