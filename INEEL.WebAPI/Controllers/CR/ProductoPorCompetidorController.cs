...
{
    public class ProductoPorCompetidorController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(ProductoPorCompetidorController));

        private ProductoPorCompetidorRepository _entityRepo;
        
        public ProductoPorCompetidorController()
        {
            _entityRepo = new ProductoPorCompetidorRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]ProductoPorCompetidor model)
        {
