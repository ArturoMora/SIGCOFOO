...
{
    public class ActividadAdicionalController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(ActividadAdicionalController));  
        // AYUDA:
        ...
        private ActividadAdicionalRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public ActividadAdicionalController()
        {
            _entityRepo = new ActividadAdicionalRepository();
