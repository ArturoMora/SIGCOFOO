...
{
    public class GrupoColegiadoPartIntController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(GrupoColegiadoPartIntController));  
        // AYUDA:
        ...
        private GrupoColegiadoPartIntRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public GrupoColegiadoPartIntController()
        {
            _entityRepo = new GrupoColegiadoPartIntRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpGet]
        public async Task<IHttpActionResult> GetFKById(int Id){try{log.Info(new MDCSet(this.ControllerContext.RouteData), new InfoException(Id));
