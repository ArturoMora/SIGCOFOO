...
{
    public class ProyectoPorConvocatoriaController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(ProyectoPorConvocatoriaController));  
        // AYUDA:
        ...
        private ProyectoPorConvocatoriaRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public ProyectoPorConvocatoriaController()
        {
            _entityRepo = new ProyectoPorConvocatoriaRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        //[AllowAnonymous]
        //[HttpPost]
        //public async Task<IHttpActionResult> validaExist(ProyectoPorConvocatoria model)
        //{
        //    try
        //    {
        //        await _entityRepo.ValidaExist(model);
        //        return Ok("ok");
        //    }
        //    catch (Exception e)
        //    {
