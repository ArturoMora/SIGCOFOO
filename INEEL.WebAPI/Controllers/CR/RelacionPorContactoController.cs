...
{
    public class RelacionPorContactoController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(RelacionPorContactoController));  
        // AYUDA:
        ...
        private RelacionPorContactoRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public RelacionPorContactoController()
        {
            _entityRepo = new RelacionPorContactoRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]RelacionPorContacto model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]RelacionPorContacto model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> UpdateEstado([FromBody]RelacionPorContacto model)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
