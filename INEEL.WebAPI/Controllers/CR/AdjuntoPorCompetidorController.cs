...
{
    public class AdjuntoPorCompetidorController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(AdjuntoPorCompetidorController));  
        // AYUDA:
        ...
        private AdjuntoPorCompetidorRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public AdjuntoPorCompetidorController()
        {
            _entityRepo = new AdjuntoPorCompetidorRepository();
