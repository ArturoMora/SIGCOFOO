...
{
    public class MovimientoCategoriaController : ApiController
    {
        
        private MovimientoCategoriaRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public MovimientoCategoriaController()
        {
            _entityRepo = new MovimientoCategoriaRepository();
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]MovimientoCategoria model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]MovimientoCategoria model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
