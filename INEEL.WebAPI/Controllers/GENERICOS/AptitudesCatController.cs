...
{
    public class AptitudesCatController : ApiController
    {
        private AptitudesCatRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public AptitudesCatController()
        {
            _entityRepo = new AptitudesCatRepository();
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]AptitudesCat model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]AptitudesCat model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
