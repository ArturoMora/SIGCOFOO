...
{
    public class AccesoModulosOCController : ApiController
    {

        private static readonly ILog log = LogManager.GetLogger(typeof(CategoriasController));

        AccesoModulosOCRepository _repository;

        public AccesoModulosOCController()
        {
            _repository = new AccesoModulosOCRepository();
        }
        ...
        [HttpPost]
        [Authorize]
        public async Task<IHttpActionResult> Create(AccesoOcModulos obj)
        {
            try
            {
        ...
        [Authorize]
        [HttpPut]
        public async Task<IHttpActionResult> Update(AccesoOcModulos obj)
        {
            try
            {
                log.Info(new MDCSet(this.ControllerContext.RouteData));
