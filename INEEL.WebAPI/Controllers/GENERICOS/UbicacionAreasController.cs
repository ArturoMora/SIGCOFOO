...
{
    public class UbicacionAreasController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(UbicacionAreasController));

        UbicacionAreasRepository _repository;

        public  UbicacionAreasController() {
            _repository = new UbicacionAreasRepository();
        }
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update(UbicacionAreas obj)
        {
            try { log.Info(new MDCSet(this.ControllerContext.RouteData));
                await _repository.Update(obj);
                return Ok("Ubicación actualizada correctamente!");
            }
            catch (Exception e) { log.Error(new MDCSet(this.ControllerContext.RouteData), e);
        ...
        public async Task<IHttpActionResult> Delete(int Id){try{log.Info(new MDCSet(this.ControllerContext.RouteData), new InfoException(Id));
                ...
                return Ok("Ubicación eliminada correctamente!");
