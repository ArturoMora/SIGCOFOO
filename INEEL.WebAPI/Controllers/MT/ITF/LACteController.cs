...
{
    public class LACteController : ApiController { private static readonly ILog log = LogManager.GetLogger(typeof(LACteController));
        // AYUDA:
        //LACteController.- Nombre de clase y tipicament constructor
        //LActeRepository.- La implementación CRUD del Modelo:LActe con el patrón de diseño Repository
        //_entityRepo.-      varible de tipo LActeRepository
        // entities.-        resultado de tipo Task<IEnumerable<LActe>>
        // entity.-         resultado de tipo Task<LActe>
        // LActe.-         Modelo
        private LActeRepository _entityRepo;
        //private ProductsRepositories _productRepo;
        public LACteController()
        {
            _entityRepo = new LActeRepository();
       ...
       [HttpGet] public async Task<IHttpActionResult> GetAll(){try { 
        ...
        [HttpPost]
        [Authorize] public async Task<IHttpActionResult> Create([FromBody]LActe model)
        {
        ...
        [Authorize][HttpPut]
        public async Task<IHttpActionResult> Update([FromBody]LActe model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
